      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-2 border-b border-slate-200 dark:border-slate-800/80 pb-6">
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
            Fill up the accurate details to list a new arena, stadium or court
            on SportNest network.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="space-y-5">
              <div className="form-control w-full">
                <label className="label font-bold text-sm text-slate-700 dark:text-slate-300">
                  Facility Name
                </label>
                <input
                  required
