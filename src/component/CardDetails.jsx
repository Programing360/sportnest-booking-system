    ...
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen py-12 px-4 sm:px-6 lg:px-8 flex items-center transition-colors duration-300">
      <div className="w-full max-w-6xl mx-auto bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/60 rounded-[2.5rem] p-4 sm:p-6 lg:p-8 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div data-aos="fade-right" className="lg:col-span-5 w-full h-[300px] sm:h-[400px] lg:h-[520px] relative rounded-[2rem] overflow-hidden bg-slate-100 dark:bg-slate-950 shadow-md">
            <Image
              src={image}
              alt={name}
              fill
          ...
          <div data-aos="fade-left" className="lg:col-span-7 flex flex-col justify-between h-full space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
                ...
                <div>
                  <span className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Total Capacity</span>
                  <p className="font-extrabold text-slate-800 dark:text-white text-sm sm:text-base">{capacity} Players</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
                ...
                <div>
                  <span className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Base Rate</span>
                  <p className="font-extrabold text-slate-800 dark:text-white text-sm sm:text-base">৳ {pricePerHour} / hr</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 bg-slate-900 dark:bg-slate-950/60 p-5 sm:p-6 rounded-[2rem] shadow-xl mt-6">
              <div className="text-center sm:text-left">
                <p className="text-[10px] font-black tracking-widest text-orange-400 uppercase">Estimated Price</p>
                <div className="flex items-baseline justify-center sm:justify-start text-white font-black mt-1">
                  <span className="text-2xl sm:text-3xl lg:text-4xl tracking-tight">৳ {pricePerHour}</span>
